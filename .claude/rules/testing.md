...
Los casos se ejecutan contra la **copia local** (business Demo, `127.0.0.1:5434`),
no contra produccion. Verificar con `./scripts/dev-db-switch.sh status` antes de
empezar. Ver `.claude/rules/entorno-local.md`.
