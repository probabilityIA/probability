...
| 2026-08-22 | [Tiendanube: las ordenes entran, pero la pagada queda sin estado](2026-08-22-tiendanube-ordenes-sin-estado.md) | Corregido en local (statusmapper + semilla de order_status_mappings 17), sin desplegar. Retroceso de estado desde el canal: decision pendiente |
