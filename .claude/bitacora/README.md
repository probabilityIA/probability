...
| 2026-08-31 | [WooCommerce COD: la comision del carrier se declaraba dos veces](2026-08-31-woocommerce-cod-comision-doble.md) | Corregido en local (ports.go), test actualizado. Solo 2 ordenes reales afectadas (14666, 14668 de Viga), ambas pending sin cobrar. Sin desplegar |
