...
type SubscriptionType struct {
	...
	IncludedTemplateMessages    *int           `gorm:"column:included_template_messages"`
	TemplateMessageOveragePrice *float64       `gorm:"column:template_message_overage_price;type:numeric"`
	IncludedTemplates           *int           `gorm:"column:included_templates"`
	TemplateOveragePrice        *float64       `gorm:"column:template_overage_price;type:numeric"`
