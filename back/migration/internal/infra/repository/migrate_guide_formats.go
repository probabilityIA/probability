...
func (r *Repository) seedGuideFormats(ctx context.Context) error {
	...
	seeds := []models.GuideFormat{
		...
		{Carrier: "*", Code: "probability-10x10", Label: "Cuadrada 10x10 cm", WidthCm: 10, HeightCm: 10, Adhesive: true, Strategy: "rebuild", CropURxFrac: 1, CropURyFrac: 1, SourcePage: 1, SortOrder: 100},
		{Carrier: "*", Code: "probability-10x15", Label: "Estandar 10x15 cm", WidthCm: 10, HeightCm: 15, Adhesive: true, Strategy: "rebuild", CropURxFrac: 1, CropURyFrac: 1, SourcePage: 1, SortOrder: 110},
