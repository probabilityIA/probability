...
import (
	...
	"github.com/secamc93/probability/back/testing/integrations/jumpseller/internal/handlers"
	"github.com/secamc93/probability/back/testing/shared/log"
)

type JumpsellerIntegration struct {
	handler *handlers.Handler
	logger  log.ILogger
	port    string
}

func New(logger log.ILogger, port string) *JumpsellerIntegration {
...
func (s *JumpsellerIntegration) Start() error {
