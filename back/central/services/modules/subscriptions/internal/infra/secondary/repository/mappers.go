...
func subscriptionTypeToEntity(m *models.SubscriptionType) *entities.SubscriptionType {
	return &entities.SubscriptionType{
		...
		IncludedTemplateMessages:    m.IncludedTemplateMessages,
		TemplateMessageOveragePrice: m.TemplateMessageOveragePrice,
		IncludedTemplates:           m.IncludedTemplates,
		TemplateOveragePrice:        m.TemplateOveragePrice,
		Payable:                     m.Payable,
