...
func (r *Repository) CreateSubscriptionType(ctx context.Context, subType *entities.SubscriptionType) error {
	typeDB := &models.SubscriptionType{
		...
		IncludedTemplateMessages:    subType.IncludedTemplateMessages,
		TemplateMessageOveragePrice: subType.TemplateMessageOveragePrice,
		IncludedTemplates:           subType.IncludedTemplates,
		TemplateOveragePrice:        subType.TemplateOveragePrice,
	}
...
func (r *Repository) UpdateSubscriptionType(ctx context.Context, subType *entities.SubscriptionType) error {
	updates := map[string]interface{}{
		...
		"included_template_messages":     subType.IncludedTemplateMessages,
		"template_message_overage_price": subType.TemplateMessageOveragePrice,
		"included_templates":             subType.IncludedTemplates,
		"template_overage_price":         subType.TemplateOveragePrice,
	}
