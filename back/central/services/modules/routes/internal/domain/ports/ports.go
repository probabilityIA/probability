...
type IRepository interface {
	...
	GetWarehouseOrigin(ctx context.Context, businessID, warehouseID uint) (*entities.OriginWarehouse, error)
	GetDefaultWarehouseOrigin(ctx context.Context, businessID uint) (*entities.OriginWarehouse, error)
	GetOrdersWarehouseIDs(ctx context.Context, businessID uint, orderIDs []string) ([]uint, error)
}
