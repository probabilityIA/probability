...
func (uc *UseCase) Update(ctx context.Context, dto dtos.UpdateShippingMarginDTO) (*entities.ShippingMargin, error) {
	if dto.MarginAmount < 0 || dto.InsuranceMargin < 0 || dto.CODMarginPercent < 0 || dto.CODMarginPercent > 100 || dto.CODMarginAmount < 0 {
	...
	existing.CODMarginAmount = dto.CODMarginAmount
