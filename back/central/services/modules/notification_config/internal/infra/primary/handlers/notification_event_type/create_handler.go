...
func (h *handler) Create(c *gin.Context) {
	h.logger.Info().Msg("🌐 [POST /notification-event-types] Request received")
	...
	h.logger.Info().Msg("➕ Creating notification event type via use case")
	...
	h.logger.Info().Uint("id", entity.ID).Msg("✅ Notification event type created successfully")
