...
func (uc *UseCaseCreateOrder) CreateManualOrder(ctx context.Context, req *dtos.CreateOrderRequest) (*dtos.OrderResponse, error) {
...
func (uc *UseCaseCreateOrder) applyManualDefaults(ctx context.Context, req *dtos.CreateOrderRequest) error {
	// Auto IntegrationID
...
func (uc *UseCaseCreateOrder) mapCreateRequestToDTO(req *dtos.CreateOrderRequest) *dtos.ProbabilityOrderDTO {
	now := time.Now()
