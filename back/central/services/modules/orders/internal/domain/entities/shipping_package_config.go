...
// SelectBox elige la caja mas chica (por capacidad) que cumpla dos condiciones:
// 1. Su capacidad (MaxItems) alcanza para totalQuantity unidades.
// 2. Las dimensiones del producto mas grande del pedido (itemLength/Width/Height)
//    caben fisicamente dentro de la caja (comparando lados de mayor a menor,
//    permitiendo rotacion, sin calcular volumen ni peso volumetrico).
// Si ninguna caja configurada cumple ambas condiciones, devuelve nil: el llamador
// debe usar las dimensiones reales del producto en vez de forzar una caja donde
// el producto no entra.
