...
func OrderToResponse(dto *dtos.OrderResponse) *response.Order {
	...
	return &response.Order{
		...
		ShippingOfficeName:          dto.ShippingOfficeName,
		ShippingOfficeDetails:       dto.ShippingOfficeDetails,
		ShippingNeighborhood:        dto.ShippingNeighborhood,
		ShippingComplementType:      dto.ShippingComplementType,
		ShippingComplementNumber:    dto.ShippingComplementNumber,
		ShippingTower:               dto.ShippingTower,
		ShippingBuilding:            dto.ShippingBuilding,
