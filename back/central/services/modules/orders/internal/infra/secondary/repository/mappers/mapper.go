...
func ToDBOrder(o *entities.ProbabilityOrder) *models.Order {
	...
	return &models.Order{
		...
		IsCod:                       o.IsCod,
		CodTotal:                    o.CodTotal,
		CodIncludesShipping:         o.CodIncludesShipping,
		CodCheckoutCarrierFee:       o.CodCheckoutCarrierFee,
		...
		ShippingDiscountPresentment: o.ShippingDiscountPresentment,
		...
		ShippingGeoConfidence:       o.ShippingGeoConfidence,
		ShippingAddressSource:       o.ShippingAddressSource,
		ShippingDeliveryType:        o.ShippingDeliveryType,
		ShippingOfficeCarrier:       o.ShippingOfficeCarrier,
		ShippingOfficeName:          o.ShippingOfficeName,
		ShippingOfficeDetails:       o.ShippingOfficeDetails,
		ShippingNeighborhood:        o.ShippingNeighborhood,
		ShippingComplementType:      o.ShippingComplementType,
		ShippingComplementNumber:    o.ShippingComplementNumber,
		ShippingTower:               o.ShippingTower,
		ShippingBuilding:            o.ShippingBuilding,
		...
		StatusChangedBy:             o.StatusChangedBy,
...
func ToDomainOrder(o *models.Order, imageURLBase string) *entities.ProbabilityOrder {
	...
	result := &entities.ProbabilityOrder{
		...
		IntegrationName:             o.Integration.Name,
		Platform:                    o.Platform,
		ExternalID:                  o.ExternalID,
		ChannelPackID:               o.ChannelPackID,
		OrderNumber:                 o.OrderNumber,
