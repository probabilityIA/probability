...
type IRepository interface {
	...
	SearchDaneCities(ctx context.Context, stateCode, term string, limit int) ([]DaneItem, error)
	...
	GetIntegrationConfigStringArray(ctx context.Context, integrationID uint, key string) ([]string, error)
	...
	ListPendingForManifest(ctx context.Context, filter ManifestFilter) ([]ManifestShipmentRow, int64, error)
