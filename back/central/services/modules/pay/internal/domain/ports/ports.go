...
type IRepository interface {
	...
	GetGuideStatusSummary(ctx context.Context, dto *dtos.SpendSummaryDTO) ([]dtos.GuideStatusTotal, error)
...
type IUseCase interface {
	...
	ProcessBancolombiaWebhookMessage(ctx context.Context, msg *dtos.BancolombiaWebhookMessage) error
