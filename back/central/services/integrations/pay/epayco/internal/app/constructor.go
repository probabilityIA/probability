...
// IUseCase interfaz del use case de ePayco
...
func New(
	...
	return &useCase{
		epaycoClient:      epaycoClient,
		integrationRepo:   integrationRepo,
		responsePublisher: responsePublisher,
		log:               logger.WithModule("epayco.usecase"),
	}
}
