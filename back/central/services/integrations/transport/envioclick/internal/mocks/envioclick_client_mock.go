...
func (m *EnvioClickClientMock) Quote(baseURL, apiKey string, req domain.QuoteRequest) (*domain.QuoteResponse, error) {
	if m.QuoteFn != nil {
...
func (m *EnvioClickClientMock) Generate(baseURL, apiKey string, req domain.QuoteRequest) (*domain.GenerateResponse, error) {
	if m.GenerateFn != nil {
...
func (m *EnvioClickClientMock) Track(baseURL, apiKey string, trackingNumber string) (*domain.TrackingResponse, error) {
	if m.TrackFn != nil {
...
func (m *EnvioClickClientMock) TrackByOrdersBatch(baseURL, apiKey string, orders []int64) (*domain.TrackingResponse, error) {
...
func (m *EnvioClickClientMock) Cancel(baseURL, apiKey string, idShipment string) (*domain.CancelResponse, error) {
	if m.CancelFn != nil {
...
func (m *EnvioClickClientMock) CancelBatch(baseURL, apiKey string, req domain.CancelBatchRequest) (*domain.CancelBatchResponse, error) {
