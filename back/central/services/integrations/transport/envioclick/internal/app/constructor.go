...
type IUseCase interface {
	...
	ResolveCODValue(ctx context.Context, baseURL, apiKey string, req domain.QuoteRequest, carrier string, rateID int64, netTarget float64, metas *[]domain.SyncMeta) (float64, bool)
