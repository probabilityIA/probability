...
// SerializableProbabilityOrderDTO es la estructura con etiquetas JSON para serializacion.
// Esta estructura esta en la capa de infraestructura, no en el dominio.
