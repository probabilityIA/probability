...
var (
	...
	ErrMissingAccessToken           = errors.New("falta el access_token de OAuth en las credenciales de la integracion")
	ErrMissingRefreshToken          = errors.New("falta el refresh_token de OAuth en las credenciales de la integracion")
	ErrMissingClientID              = errors.New("falta el client_id (APP ID) en las credenciales de plataforma del tipo Jumpseller")
	ErrMissingClientSecret          = errors.New("falta el client_secret (APP SECRET) en las credenciales de plataforma del tipo Jumpseller")
	ErrTokenRefreshFailed           = errors.New("no se pudo renovar el access_token de Jumpseller")
)
