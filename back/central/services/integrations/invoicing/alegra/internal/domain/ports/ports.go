...
// ═══════════════════════════════════════════════════════════════
// CLIENTE DE ALEGRA (Secondary Port - Driven Adapter)
// ═══════════════════════════════════════════════════════════════

// IAlegraClient define las operaciones con la API de Alegra
type IAlegraClient interface {
	...
	TestAuthentication(ctx context.Context, email, token, baseURL string) error
...
type IInvoiceUseCase interface {
	...
	// contra la API de Alegra. Llamado desde el contrato global IIntegrationContract.
