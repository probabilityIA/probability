...
type IFactusClient interface {
	...
	TestAuthentication(ctx context.Context, baseURL, clientID, clientSecret, username, password string) error

	// CreateInvoice crea una factura en Factus
	...
	// Requiere credenciales para obtener/renovar el token de autenticación
	ListBills(ctx context.Context, credentials dtos.Credentials, params dtos.ListBillsParams) (*dtos.ListBillsResult, error)
