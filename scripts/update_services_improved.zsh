...
echo -e "${GREEN}   ✓ Frontend: https://app.probabilityia.com.co${NC}"
echo -e "${GREEN}   ✓ Backend:  https://app.probabilityia.com.co/api/v1${NC}"
echo -e "${GREEN}   ✓ Swagger:  https://app.probabilityia.com.co/swagger/${NC}"
echo ""
