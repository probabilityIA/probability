...
/// Module wrapper for Notification Config.
...
class NotificationsModuleScreen extends StatefulWidget {
  ...
  @override
  State<NotificationsModuleScreen> createState() =>
      _NotificationsModuleScreenState();
}
...
class _NotificationsModuleScreenState extends State<NotificationsModuleScreen> {
        ...
        body: TabBarView(
          children: [
            NotificationConfigScreen(
              key: ValueKey('notification_config_$effectiveBusinessId'),
  ...
  PreferredSizeWidget _buildTabBar() {
    return const TabBar(
      tabs: [
        Tab(icon: Icon(Icons.notifications), text: 'Configuraciones'),
      ],
    );
  }
