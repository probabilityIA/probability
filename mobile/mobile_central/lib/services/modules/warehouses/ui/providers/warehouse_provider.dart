...
class WarehouseProvider extends ChangeNotifier {
  ...
  Future<Warehouse?> createWarehouse(CreateWarehouseDTO data, {int? businessId}) async {
    try { return await _useCases.createWarehouse(data, businessId: businessId); } catch (e) { _error = e.toString(); notifyListeners(); return null; }
  }

  Future<bool> deleteWarehouse(int id, {int? businessId}) async {
    try { await _useCases.deleteWarehouse(id, businessId: businessId); return true; } catch (e) { _error = e.toString(); notifyListeners(); return false; }
  }
