                ...
                <div className="md:col-span-2 space-y-6">
                    ...
                    <section className="bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-8 shadow-xl shadow-gray-200/50 dark:shadow-none transition-all hover:shadow-2xl hover:shadow-gray-200/50">
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <Link
                                href="/products"
                                className="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-indigo-600 transition-colors flex items-center gap-1"
                            >
                                Ver todos
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <Link href="/products/new" className="flex flex-col items-center justify-center gap-2 bg-white dark:bg-white/5 border-2 border-dashed border-gray-200 dark:border-white/10 rounded-2xl p-4 transition-all hover:border-indigo-400 hover:bg-indigo-50/30 group cursor-pointer min-h-[120px]">
                                ...
                                <span className="text-sm font-medium text-gray-600 dark:text-gray-300 dark:text-gray-300 group-hover:text-indigo-600">Crear Nuevo</span>
                            </Link>
                        </div>
                    </section>
                </div>
                    ...
                    <div className="bg-gradient-to-br from-indigo-900 to-purple-900 text-white rounded-3xl p-6 shadow-xl relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <button
                                ...
                                className="w-full py-3 bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white dark:text-white border border-blue-600 dark:border-blue-700 rounded-xl text-sm font-semibold transition-all flex items-center justify-center gap-2"
                            >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="pt-2">
                    {passwordSuccess ? (
                        <div className="flex flex-col items-center justify-center py-8 text-center animate-in zoom-in duration-300">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">¡Contraseña Actualizada!</h3>
                            <p className="text-gray-500 dark:text-gray-400">Tu cuenta está segura con tu nueva contraseña.</p>
                        </div>
                    ) : (
                        <ChangePasswordForm
