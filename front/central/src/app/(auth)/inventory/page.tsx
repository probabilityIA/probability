...
export default function InventoryStockPage() {
    ...
    useEffect(() => {
        ...
        const actionButtons = (
            <>
                <button
                    onClick={() => { setSelectedProductId(undefined); setModalType('adjust'); }}
                    title="Ajustar stock"
                ...
                <button
                    onClick={() => { setSelectedProductId(undefined); setModalType('transfer'); }}
                    title="Transferir"
                    className="p-2 rounded-md btn-business-primary transition-colors"
                >
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
            <div className="space-y-4">                {requiresBusinessSelection ? (
