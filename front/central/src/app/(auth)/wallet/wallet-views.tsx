    ...
    return (
        <>
            ...
            <div className="mt-12 space-y-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
                    <div className="flex gap-8 mb-6 border-b border-gray-200 dark:border-gray-700 pb-4 items-center">
                        <h3 className="font-semibold text-gray-900 dark:text-white whitespace-nowrap">Historial de transacciones</h3>
                        ...
                        <div className="flex gap-2 bg-gray-100 dark:bg-gray-700 p-1 rounded-xl ml-auto">
