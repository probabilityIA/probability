                    ...
                    {cart.length === 0 ? (
                        ...
                        <form onSubmit={handleSubmit}>
                                ...
                                {cart.map(item => (
                                    <div key={item.product.id} className="flex items-center justify-between gap-2 text-sm">
                                        ...
                                        <div className="flex items-center gap-1">
                                            <button type="button" onClick={() => updateQuantity(item.product.id, -1)} className="p-1 text-gray-400 hover:text-gray-600">
                            ...
                            <div className="space-y-2 mb-4">
                                <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Direccion de envio (opcional)</h4>
                                <input
                                    type="text"
                                    placeholder="Nombre"
