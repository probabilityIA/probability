...
export default function TicketDetail({ ticket, isSuperAdmin, onClose, onChanged }: Props) {
    ...
    return (
        <div className="flex h-full min-h-0 flex-col">
            ...
            <div className="flex shrink-0 items-start justify-between gap-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-t-2xl px-6 pt-6 pb-4 sm:px-8">
                ...
                <div className="flex items-center gap-2 shrink-0">
                    ...
                    <button
                        ...
                        title="Cerrar"
                        aria-label="Cerrar"
                        className="inline-flex items-center justify-center w-8 h-8 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100 transition"
                    >
            ...
            <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden px-6 py-5 sm:px-8">
            ...
            <div className="flex shrink-0 items-center justify-between gap-3 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-b-2xl px-6 py-4 sm:px-8">
                <span className="text-[11px] text-gray-400 dark:text-gray-500">
                ...
                {isSuperAdmin && (
                    <button
                        ...
                        className="inline-flex items-center gap-1.5 h-9 px-3 rounded-lg border border-red-300 dark:border-red-800 text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 transition"
                    >
