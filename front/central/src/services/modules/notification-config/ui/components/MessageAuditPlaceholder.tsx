  ...
  return (
    <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
      ...
      <div className="p-4 space-y-4">
        ...
        {/* Chart placeholder */}
        <div className="h-32 rounded-lg border-2 border-dashed border-gray-200 dark:border-gray-700 flex items-center justify-center">
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-white dark:bg-gray-800/60 backdrop-blur-[1px] flex items-center justify-center rounded-lg">
