        ...
        <div className="space-y-2">
          ...
          {orderStatuses.length > 0 && (
            <div className="flex gap-2">
              ...
              <button
                ...
                className="text-xs text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-200 font-medium"
              >
                Limpiar
              </button>
            </div>
          ...
          <div className="border rounded-lg max-h-[400px] overflow-y-auto p-3">
            {loadingOrderStatuses ? (
              <p className="text-sm text-gray-500 dark:text-gray-400">Cargando estados...</p>
            ) : orderStatuses.length === 0 ? (
              <p className="text-sm text-gray-500 dark:text-gray-400">No hay estados disponibles</p>
            ) : (
