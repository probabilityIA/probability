/**
 * IntegrationConfigList - Lista de configuraciones de notificación por integración
...
import type { IntegrationNotificationConfig } from '../../domain/integration-types';
import { useIntegrationNotificationConfigs } from '../hooks/useIntegrationNotificationConfigs';
...
export function IntegrationConfigList({ integrationId, onEdit, onDelete }: IntegrationConfigListProps) {
  const { configs, loading, error, toggleConfig } = useIntegrationNotificationConfigs({
