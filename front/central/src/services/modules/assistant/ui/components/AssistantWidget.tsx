...
export function AssistantWidget() {
    ...
    if (open) {
        return <AssistantPanel chat={chat} suggestions={pickSuggestions(hasNav)} onClose={closePanel} />;
    }
    ...
    return (
        <div className="fixed bottom-5 right-5 z-40 flex items-end gap-3">
            ...
            >
                <AssistantAvatar size={56} mood={chat.pending ? 'thinking' : 'idle'} />
