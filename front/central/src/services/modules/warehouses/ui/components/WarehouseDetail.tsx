    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex items-start justify-between">
                <div>
                    <h2 className="text-lg font-semibold text-gray-900 dark:text-white">{warehouse.name}</h2>
                    <span className="text-sm font-mono text-gray-500 dark:text-gray-400">{warehouse.code}</span>
