...
const getCarrierLogo = (carrierName: string): string => {
    const carrierLogos: { [key: string]: string } = {
        ...
        'FEDEX': 'https://probability-media-assets.s3.us-east-1.amazonaws.com/public/carriers/imagen_fedex.png',
        ...
        'TRANSPORTADORADECARACOLOMBIA': 'https://probability-media-assets.s3.us-east-1.amazonaws.com/public/carriers/imagen_TCC.png',
        '99MINUTOS': 'https://probability-media-assets.s3.us-east-1.amazonaws.com/public/carriers/imagen_99minutos.webp',
        'DEPRISA': 'https://probability-media-assets.s3.us-east-1.amazonaws.com/public/carriers/imagen_deprisa.png',
        'MENSAJERIAUBANA': 'https://probability-media-assets.s3.us-east-1.amazonaws.com/public/carriers/imagen_mensajerosUrbanos.png',
        'MENSAJER\u00cdA URBANA': 'https://probability-media-assets.s3.us-east-1.amazonaws.com/public/carriers/imagen_mensajerosUrbanos.png',
        'MENSAJEROS_URBANOS_EXPRESS': 'https://probability-media-assets.s3.us-east-1.amazonaws.com/public/carriers/imagen_mensajerosUrbanos.png',
        'MENSAJERIAURBANOSEXPRESS': 'https://probability-media-assets.s3.us-east-1.amazonaws.com/public/carriers/imagen_mensajerosUrbanos.png',
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="grid grid-cols-2 gap-5">
                                                    <div>
                                                        <div className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-3">Desglose</div>
                                                    ...
                                                    <div className="bg-white dark:bg-gray-800/60 rounded-xl p-5 flex flex-col justify-center border-2 border-gray-300 dark:border-gray-600">
