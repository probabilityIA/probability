...
export function InvoiceForm({ concepts, taxes, invoice, error }: InvoiceFormProps) {
    ...
    const handleSubmit = async () => {
        ...
        if (result.success) {
            ...
            router.push(`/accounting/facturas/${result.data.id}`);
        } else {
    ...
    return (
        <div className="space-y-4 max-w-4xl">
            <div className="flex items-center justify-between gap-3">
                <div>
                    <h1 className="text-xl font-semibold text-gray-900 dark:text-white">
                        {isEdit ? `Editar factura ${invoice?.number}` : 'Nueva factura'}
                    </h1>
                ...
                <Link
                    href={isEdit && invoice ? `/accounting/facturas/${invoice.id}` : '/accounting/facturas'}
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-4 sm:p-6 space-y-4">
                {!isEdit && (
                    <div>
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-4 sm:p-6 space-y-4">
                <div className="flex items-center justify-between">
                    <h2 className="text-sm font-semibold text-gray-900 dark:text-white uppercase">Items</h2>
                    <button
