...
import { WorldOfficeCredentials } from '../../domain/types';
...
interface WorldOfficeConfigFormProps {
    onSuccess?: () => void;
    onCancel?: () => void;
}

export function WorldOfficeConfigForm({ onSuccess, onCancel }: WorldOfficeConfigFormProps) {
    ...
    const handleTestConnection = async () => {
        ...
        try {
            ...
            const result = await testConnectionRawAction('world_office', {}, credentials);
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            const credentials: WorldOfficeCredentials = {
                username: formData.username,
                password: formData.password,
                company_code: formData.company_code,
                base_url: formData.base_url || undefined,
        ...
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                        World Office Facturacion Electronica
                    </h2>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 ml-14">
                    Conecta tu cuenta de World Office para gestionar facturacion electronica automaticamente desde Probability.
                </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-6 space-y-4 border border-orange-100">
                ...
                <p className="text-sm text-orange-900 -mt-2 mb-4 flex items-start gap-2">
                    ...
                    <span>
                        Obten tus credenciales desde el panel de administracion de World Office.
                    </span>
                </p>
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200 mb-2">
                        Codigo de Empresa <span className="text-red-500">*</span>
                    </label>
                    <Input
                        type="text"
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1.5">
                        Codigo unico asignado a tu empresa en World Office
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1.5 flex items-start gap-1">
                        <InformationCircleIcon className="w-4 h-4 mt-0.5 flex-shrink-0" />
                        <span>Dejar vacio para usar la URL de producción de World Office.</span>
                    </p>
                </div>
