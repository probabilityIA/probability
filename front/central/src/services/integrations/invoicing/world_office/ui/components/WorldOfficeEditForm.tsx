...
interface WorldOfficeEditFormProps {
...
export function WorldOfficeEditForm({ integrationId, initialData, onSuccess, onCancel }: WorldOfficeEditFormProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        company_code: initialData.credentials?.company_code || '',
