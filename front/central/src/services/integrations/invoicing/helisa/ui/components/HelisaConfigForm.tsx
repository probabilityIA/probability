...
import { HelisaCredentials } from '../../domain/types';
...
interface HelisaConfigFormProps {
    onSuccess?: () => void;
    onCancel?: () => void;
}

export function HelisaConfigForm({ onSuccess, onCancel }: HelisaConfigFormProps) {
    ...
    const handleTestConnection = async () => {
        if (!formData.username || !formData.password) {
            showToast('Debes ingresar Usuario y Contrasena para probar la conexion', 'warning');
            return;
        }
        ...
        try {
            ...
            const result = await testConnectionRawAction('helisa', {}, credentials);
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            const credentials: HelisaCredentials = {
                username: formData.username,
                password: formData.password,
                company_id: formData.company_id,
                base_url: formData.base_url || undefined,
            ...
            const response = await createIntegrationAction({
                name: formData.name,
                code: `helisa_${Date.now()}`,
                integration_type_id: 11,
                category: 'invoicing',
        ...
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            ...
            <div className="border-b border-gray-200 pb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">
                        Helisa Facturacion Electronica
                    </h2>
                </div>
                <p className="text-sm text-gray-600 ml-14">
                    Conecta tu cuenta de Helisa para gestionar facturacion electronica automaticamente desde Probability.
                </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl p-6 space-y-4 border border-teal-100">
                ...
                <p className="text-sm text-teal-900 -mt-2 mb-4 flex items-start gap-2">
                    ...
                    <span>
                        Obten tus credenciales desde el panel de administracion de Helisa.
                    </span>
                </p>
                ...
                <div>
                    ...
                    <Input
                        ...
                        placeholder="ID de empresa en Helisa"
                        required
                        autoComplete="off"
                        data-1p-ignore
                    ...
                    <p className="text-xs text-gray-500 mt-1.5">
                        Identificador unico de tu empresa en Helisa
                    </p>
                </div>
                ...
                <div>
                    ...
                    <Input
                        ...
                        placeholder="https://api.helisa.com"
                        autoComplete="off"
                        className="bg-white font-mono text-sm"
                    />
                    <p className="text-xs text-gray-500 mt-1.5 flex items-start gap-1">
                ...
                <div className="pt-2">
                    <Button
                        type="button"
                        variant="outline"
                        className="w-full bg-white hover:bg-teal-50 border-teal-200 text-teal-700 font-semibold"
