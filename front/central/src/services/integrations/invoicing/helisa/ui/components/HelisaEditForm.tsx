...
export function HelisaEditForm({ integrationId, initialData, onSuccess, onCancel }: HelisaEditFormProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        company_id: initialData.credentials?.company_id || '',
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (response.success) {
                showToast('Integracion Helisa actualizada exitosamente', 'success');
                onSuccess?.();
            } else {
                throw new Error(response.message || 'Error al actualizar integracion');
            }
        } catch (err: any) {
            setErrorModal(err.message || 'Error al actualizar integracion de Helisa');
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="border-b border-gray-200 pb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">
                        Editar Helisa Facturacion
                    </h2>
                </div>
                <p className="text-sm text-gray-600 ml-14">
                    Actualiza la configuracion de tu integracion con Helisa.
                </p>
            </div>
