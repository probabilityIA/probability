...
interface MiPaqueteEditFormProps {
...
export function MiPaqueteEditForm({ integrationId, initialData, onSuccess, onCancel }: MiPaqueteEditFormProps) {
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                        Editar MiPaquete - Logistica
                    </h2>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 ml-14">
                    Actualiza la configuracion de tu integracion con MiPaquete.
                </p>
            </div>
