...
import { MiPaqueteConfig, MiPaqueteCredentials } from '../../domain/types';
...
interface MiPaqueteConfigFormProps {
    onSuccess?: () => void;
    onCancel?: () => void;
}

export function MiPaqueteConfigForm({ onSuccess, onCancel }: MiPaqueteConfigFormProps) {
    ...
    const handleTestConnection = async () => {
        ...
        try {
            const config: MiPaqueteConfig = {
                base_url: formData.base_url || undefined,
            };

            const credentials: MiPaqueteCredentials = {
                api_key: formData.api_key,
            };

            const result = await testConnectionRawAction('mipaquete', config, credentials);
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            const response = await createIntegrationAction({
                name: formData.name,
                code: `mipaquete_${Date.now()}`,
                integration_type_id: 15,
                category: 'shipping',
        ...
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 ml-14">
                    Conecta tu cuenta de MiPaquete para gestionar envios y cotizaciones de paqueteria desde Probability.
                </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 space-y-4">
                ...
                <div>
                    ...
                    <Input
                        ...
                        placeholder="Ej: MiPaquete Principal"
                        required
            ...
            {/* Credenciales de API */}
            <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-6 space-y-4 border border-purple-100">
                <div className="flex items-center gap-2 mb-4">
                ...
                <p className="text-sm text-purple-900 -mt-2 mb-4 flex items-start gap-2">
                    ...
                    <span>
                        Obtiene tu API Key desde el panel de MiPaquete en la seccion de
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            <Input
                                ...
                                placeholder="Ingresa tu API Key de MiPaquete"
                                required
                                autoComplete="off"
                                data-1p-ignore
                    ...
                    <div className="pt-2">
                        <Button
                            type="button"
                            variant="outline"
                            className="w-full bg-white dark:bg-gray-800 hover:bg-purple-50 border-purple-200 text-purple-700 font-semibold"
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 space-y-4">
                ...
                <div>
                    ...
                    <Input
                        ...
                        placeholder="https://api.mipaquete.com/api/v1"
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1.5">
                        URL base del servicio de MiPaquete (no modificar salvo indicacion del soporte)
                    </p>
                </div>
            </div>
