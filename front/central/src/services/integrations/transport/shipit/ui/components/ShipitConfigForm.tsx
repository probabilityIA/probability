...
export function ShipitConfigForm({ onSuccess, onCancel }: ShipitConfigFormProps) {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (response.success) {
                showToast('Integracion Shipit creada exitosamente', 'success');
                onSuccess?.();
            } else {
            ...
            showToast('Error al crear integracion Shipit', 'error');
        } finally {
            setLoading(false);
        }
    };
        ...
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 ml-14">
                    Conecta tu cuenta de Shipit (Chile) para generar envios, cotizar tarifas entre couriers y hacer seguimiento desde Probability.
                </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl p-6 space-y-4 border border-teal-100">
                ...
                <p className="text-sm text-teal-900 -mt-2 mb-4 flex items-start gap-2">
                    ...
                    <span>
                        Obtiene tus credenciales desde el panel de Shipit en
                        <strong> Configuracion / API</strong> (app.shipit.cl/settings)
                    </span>
                </p>
