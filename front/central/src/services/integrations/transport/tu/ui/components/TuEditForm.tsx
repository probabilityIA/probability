...
export function TuEditForm({ integrationId, initialData, onSuccess, onCancel }: TuEditFormProps) {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (response.success) {
                showToast('Integracion TU actualizada exitosamente', 'success');
                onSuccess?.();
            } else {
            ...
            showToast('Error al actualizar integracion TU', 'error');
        } finally {
            setLoading(false);
        }
    };
        ...
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            ...
            <div className="border-b border-gray-200 pb-6">
                ...
                <p className="text-sm text-gray-600 ml-14">
                    Actualiza la configuracion de tu integracion con TU.
                </p>
            </div>
