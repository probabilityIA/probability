...
export function BoldEditForm({ integrationId, initialData, onSuccess, onCancel }: BoldEditFormProps) {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (response.success) {
                showToast('Integración Bold actualizada exitosamente', 'success');
                onSuccess?.();
            } else {
            ...
            showToast('Error al actualizar integración Bold', 'error');
        } finally {
            setLoading(false);
        }
    };
        ...
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Editar Bold Pagos</h2>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 ml-14">
                    Actualiza la configuración de tu integración con Bold.
                </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 space-y-4 border border-blue-100">
                ...
                <p className="text-sm text-blue-900 -mt-2 mb-4 flex items-start gap-2">
                    ...
                    <span>Actualiza las credenciales si necesitas cambiarlas. Deja el campo vacío para mantener las actuales.</span>
                </p>
