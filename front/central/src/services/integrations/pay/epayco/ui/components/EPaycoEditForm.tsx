    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            <div className="border-b border-gray-200 pb-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 ml-14">Actualiza la configuración de tu integración con ePayco.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl p-6 space-y-4 border border-teal-100">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Customer ID</label>
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Key (P_KEY)</label>
                    <div className="relative">
                        ...
                        <button type="button" onClick={() => setShowKey(!showKey)} className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-200 focus:outline-none" tabIndex={-1}>
