...
interface EPaycoConfigFormProps {
...
export function EPaycoConfigForm({ integrationTypeId, onSuccess, onCancel, integrationTypeBaseURLTest }: EPaycoConfigFormProps) {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (response.success) {
                showToast('Integración ePayco creada exitosamente', 'success');
                onSuccess?.();
            } else {
        ...
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            ...
            <div className="border-b border-gray-200 pb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">ePayco Pagos</h2>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300 ml-14">
                    Conecta tu cuenta de ePayco para procesar pagos con tarjeta, PSE y efectivo en Colombia.
                </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                ...
                <div>
                    ...
                    <Input
                        ...
                        placeholder="Ej: ePayco Principal"
                        required
                        className="bg-white"
                    />
                </div>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-xl p-6 space-y-4 border border-teal-100">
                ...
                <p className="text-sm text-teal-900 -mt-2 mb-4 flex items-start gap-2">
                    ...
                    <span>
                        Obtén tu Customer ID y Key desde el panel de ePayco en <strong>Mis Datos → Llaves API</strong>.
                    </span>
                </p>
                ...
                <div>
                    ...
                    <Select
                        ...
                        onChange={(e) => setFormData({ ...formData, environment: e.target.value as 'test' | 'production' })}
                        options={[
                ...
                <div>
                    ...
                    <Input
                        ...
                        placeholder="Tu Customer ID de ePayco"
                        required
                        autoComplete="off"
                        data-1p-ignore
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                        Key (P_KEY) <span className="text-red-500">*</span>
                    </label>
                    ...
                    <div className="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-orange-700 mt-0.5">
                                Los pagos serán procesados en el ambiente de pruebas de ePayco.
