...
export function PayUConfigForm({ integrationTypeId, onSuccess, onCancel, integrationTypeBaseURLTest }: PayUConfigFormProps) {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (response.success) {
                showToast('Integración PayU creada exitosamente', 'success');
                onSuccess?.();
            } else {
            ...
            showToast('Error al crear integración PayU', 'error');
        } finally {
            setLoading(false);
        }
    };
        ...
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">PayU Pagos</h2>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 ml-14">
                    Conecta tu cuenta de PayU para procesar pagos con tarjeta, PSE y efectivo en Latinoamérica.
                </p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <Input
                            ...
                            placeholder="ID de tu cuenta PayU"
                            className="bg-white dark:bg-gray-800"
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            ...
                            placeholder="ID de tu comercio PayU"
                            className="bg-white dark:bg-gray-800"
                        />
                    </div>
                </div>
                <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 flex items-start gap-1">
                    <InformationCircleIcon className="w-4 h-4 mt-0.5 flex-shrink-0" />
                    <span>Puedes encontrar el Account ID y Merchant ID en tu panel de PayU en <strong>Configuración → Datos técnicos</strong>.</span>
                </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-6 space-y-4 border border-orange-100">
                ...
                <p className="text-sm text-orange-900 -mt-2 mb-4 flex items-start gap-2">
                    ...
                    <span>
                        Obtén tus credenciales desde el panel de PayU en <strong>Configuración → Datos técnicos → API Key y API Login</strong>.
                    </span>
                </p>
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 dark:text-gray-200 mb-2">
                        API Login <span className="text-red-500">*</span>
                    </label>
                    <Input
                        type="text"
                    ...
                    <div className="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-orange-700 mt-0.5">
                                Los pagos serán procesados en el ambiente de pruebas de PayU.
