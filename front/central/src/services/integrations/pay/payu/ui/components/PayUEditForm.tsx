    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            <div className="border-b border-gray-200 pb-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 ml-14">Actualiza la configuración de tu integración con PayU.</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Account ID</label>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Merchant ID</label>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-6 space-y-4 border border-orange-100">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">API Login</label>
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <button type="button" onClick={() => setShowApiKey(!showApiKey)} className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-200 focus:outline-none" tabIndex={-1}>
