...
interface MeliPagoConfigFormProps {
...
export function MeliPagoConfigForm({ integrationTypeId, onSuccess, onCancel, integrationTypeBaseURLTest }: MeliPagoConfigFormProps) {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (response.success) {
                showToast('Integración MercadoPago creada exitosamente', 'success');
                onSuccess?.();
            } else {
            ...
            showToast('Error al crear integración MercadoPago', 'error');
        } finally {
            setLoading(false);
        }
    };
        ...
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">MercadoPago</h2>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 ml-14">
                    Conecta tu cuenta de MercadoPago para recibir pagos con tarjeta, efectivo y más en Latinoamérica.
                </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-xl p-6 space-y-4 border border-yellow-100">
                ...
                <p className="text-sm text-yellow-900 -mt-2 mb-4 flex items-start gap-2">
                    ...
                    <span>
                        Obtén tu Access Token desde el panel de MercadoPago en <strong>Tu negocio → Configuración → Gestión y administración → Credenciales</strong>.
                    </span>
                </p>
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1.5">
                        Sandbox: <code>TEST-...</code> | Producción: <code>APP_USR-...</code>
                    </p>
                </div>
            </div>
                    ...
                    <div className="flex items-start gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-orange-700 mt-0.5">
                                Los pagos serán procesados en el ambiente de pruebas de MercadoPago. Usa las tarjetas de prueba del sandbox.
            ...
            <div className="flex justify-between items-center gap-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <Button
                    ...
                    variant="primary"
                    disabled={loading}
                    className="min-w-[200px] bg-yellow-500 hover:bg-yellow-600 text-white font-semibold"
                >
                    {loading ? (
                        <>
