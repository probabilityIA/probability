...
export function TikTokConfigForm({ onSuccess, onCancel }: TikTokConfigFormProps) {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            const response = await createIntegrationAction({
                name: formData.name,
                code: `tiktok_${Date.now()}`,
                integration_type_id: 35,
                category: 'ecommerce',
                business_id: isSuperAdmin ? selectedBusinessId : null,
                config: { shop_name: formData.shop_name } as any,
        ...
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 ml-14">
                    Conecta tu app de TikTok for Developers para monitorear las metricas de tu TikTok Shop (rating, resenas y ventas) con snapshots historicos.
                </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-rose-50 dark:from-gray-800 dark:to-gray-800 rounded-xl p-6 space-y-4 border border-cyan-100 dark:border-gray-700">
                ...
                <p className="text-sm text-cyan-900 dark:text-cyan-200 -mt-2 mb-4 flex items-start gap-2">
                    ...
                    <span>
                        ...
                        <strong> TikTok for Developers &rarr; Manage apps &rarr; Credentials</strong>
                    </span>
                </p>
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1.5">
                        Client Key de tu app en TikTok for Developers
                    </p>
                </div>
                ...
                <div className="pt-2">
                    ...
                    >
                        {testingConnection ? (
                            <>
                                <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-cyan-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                                Probando...
                ...
                <div className="bg-cyan-50 dark:bg-gray-700 border border-cyan-200 dark:border-gray-600 rounded-lg p-4 mt-4">
                    ...
                    <ol className="text-xs text-cyan-800 dark:text-cyan-300 space-y-2 list-decimal list-inside ml-1">
                        <li>Crea una app en <strong>TikTok for Developers</strong> (developers.tiktok.com)</li>
                        <li>Solicita acceso a la <strong>Research API</strong> (scope research.data.basic)</li>
                        <li>Ve a <strong>Manage apps &rarr; tu app &rarr; Credentials</strong></li>
                        <li>Copia tu <strong>Client Key</strong> y <strong>Client Secret</strong></li>
                    </ol>
                </div>
            </div>
