...
interface MercadoLibreOAuthFormProps {
    onCancel?: () => void;
}
...
const GUIDE_STEPS = [
    ...
    'Inicia sesion con tu cuenta vendedor',
        ...
        <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-300">
                            Conecta tu cuenta con OAuth para sincronizar ordenes y recibir notificaciones en tiempo real.
                        </p>
                    </div>
                </div>
                <span
                        ...
                        <div className="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <p className="mt-0.5 text-[11px] text-gray-400 dark:text-gray-500">
                                    Conecta usando la app sandbox (credenciales de test del tipo de integracion) en vez de la de produccion.
                                </p>
                            </div>
                        </div>
                        <button
            ...
            >
                ...
                <p className="text-[12px] text-gray-500 dark:text-gray-400 leading-relaxed mb-3">
                    Te redirigimos a MercadoLibre para que autorices el acceso. No necesitas pegar tokens: al
                ...
                <button
                    ...
                    disabled={connecting}
                    className="w-full flex items-center justify-center gap-2 rounded-lg py-2.5 text-[13px] font-semibold text-white transition-colors disabled:opacity-60"
                    style={{ backgroundColor: GREEN }}
