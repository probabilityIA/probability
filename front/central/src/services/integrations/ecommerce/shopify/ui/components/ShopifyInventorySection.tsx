...
interface ShopifyInventorySectionProps {
    value: ShopifyInventoryConfig;
    onChange: (v: ShopifyInventoryConfig) => void;
...
export function ShopifyInventorySection({ value, onChange, businessId, integrationId, onSyncNow, canSyncNow }: ShopifyInventorySectionProps) {
    ...
    const set = (patch: Partial<ShopifyInventoryConfig>) => onChange({ ...value, ...patch });
        ...
        >
            ...
            {value.enabled && (
                <div className="mt-4 space-y-4">
                    <div>
                        <label className={fieldLabel}>Que stock enviar a Shopify</label>
                    ...
                    <p className="text-[11px] text-gray-500 dark:text-gray-400 flex items-start gap-1">
                        ...
                        <span>Solo se actualizan productos ya vinculados. El match es por SKU. Sin emparejamiento de locations, se usa la location por defecto.</span>
                    </p>
