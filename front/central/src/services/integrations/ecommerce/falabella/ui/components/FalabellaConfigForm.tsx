...
interface FalabellaConfigFormProps {
    onSuccess?: () => void;
    onCancel?: () => void;
}

export function FalabellaConfigForm({ onSuccess, onCancel }: FalabellaConfigFormProps) {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            const response = await createIntegrationAction({
                name: formData.name,
                code: `falabella_${Date.now()}`,
                integration_type_id: 20,
                category: 'ecommerce',
        ...
        <form onSubmit={handleSubmit} className="space-y-8" autoComplete="off">
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 ml-14">
                    Conecta tu cuenta de Falabella Seller Center para sincronizar ordenes y productos desde el marketplace de Falabella.
                </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-lime-50 to-green-50 rounded-xl p-6 space-y-4 border border-lime-100">
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1.5">
                        User ID de tu cuenta en Falabella Seller Center
                    </p>
                </div>
                ...
                <div className="pt-2">
                    <Button
                        type="button"
                        variant="outline"
                        className="w-full bg-white dark:bg-gray-800 hover:bg-lime-50 border-lime-200 text-lime-700 font-semibold"
                ...
                <div className="bg-lime-100 border border-lime-200 rounded-lg p-4 mt-4">
                    <h4 className="text-sm font-semibold text-lime-900 mb-3 flex items-center gap-2">
