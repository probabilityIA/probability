...
import { ShopifyWebhookInfo } from '@/services/integrations/core/domain/types';
import {
    listWebhooksAction,
    createWebhookAction,
    deleteWebhookAction,
...
interface JumpsellerWebhookManagerProps {
...
const TOPIC_LABELS: Record<string, string> = {
    ...
    order_abandoned: 'Orden abandonada',
...
export function JumpsellerWebhookManager({ integrationId }: JumpsellerWebhookManagerProps) {
    ...
    return (
        <div className="space-y-3">
            ...
            <p className="text-[11px] text-gray-500 dark:text-gray-400">
                Probability registra los webhooks en tu tienda Jumpseller. Cuando una orden se cree, se pague, se envie o se
                cancele, la recibiras aqui en tiempo real sin configurarlos a mano.
            </p>
