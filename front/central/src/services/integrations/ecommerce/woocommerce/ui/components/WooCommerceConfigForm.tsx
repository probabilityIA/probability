                    ...
                    <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-3 mb-4">
                        <div className="flex items-center justify-between gap-3">
                            ...
                            <button
                                type="button"
                                role="switch"
                                aria-checked={!disableAddressMap}
                                onClick={() => setDisableAddressMap((v) => !v)}
                                className={`relative inline-flex h-6 w-11 flex-shrink-0 items-center rounded-full transition-colors ${!disableAddressMap ? 'bg-[var(--color-primary)]' : 'bg-gray-300 dark:bg-gray-600'}`}
                            >
                                <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${!disableAddressMap ? 'translate-x-6' : 'translate-x-1'}`} />
                            </button>
                        </div>
                    </div>
