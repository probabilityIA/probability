...
export async function compareWooInventoryAction(integrationId: number, businessId?: number, page = 1, pageSize = 100, skus?: string[], opciones?: CompareInventoryOptions) {
