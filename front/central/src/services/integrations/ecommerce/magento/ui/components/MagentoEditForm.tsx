...
interface MagentoEditFormProps {
...
export function MagentoEditForm({ integrationId, initialData, onSuccess, onCancel }: MagentoEditFormProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        store_url: initialData.config?.store_url || '',
            ...
            <div className="border-b border-gray-200 pb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900">
                        Editar Magento / Adobe Commerce
                    </h2>
                </div>
                <p className="text-sm text-gray-600 ml-14">
                    Actualiza la configuracion de tu integracion con Magento.
                </p>
            </div>
