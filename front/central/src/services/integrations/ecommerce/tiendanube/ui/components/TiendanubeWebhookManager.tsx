...
import type { IntegrationWebhookInfo } from '@/services/integrations/core/domain/types';

interface TiendanubeWebhookManagerProps {
...
export function TiendanubeWebhookManager({ integrationId }: TiendanubeWebhookManagerProps) {
    const { showToast } = useToast();
    const [webhooks, setWebhooks] = useState<IntegrationWebhookInfo[]>([]);
        ...
        <div className="space-y-3">
            ...
            {webhooks.length === 0 ? (
                <p className="text-[11px] text-gray-400 dark:text-gray-500">
                    No hay webhooks configurados. Crea los webhooks para recibir eventos de Tiendanube.
                </p>
            ) : (
                <div
