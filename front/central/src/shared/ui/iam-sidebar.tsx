...
export function IAMSidebar() {
    ...
    const hasAnyPermission = canViewBusinesses || canViewUsers || canViewRoles || canViewPermissions || canViewResources;
    if (!hasAnyPermission) {
        return null;
    }
    ...
    return (
        <aside
            className="fixed top-0 h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-20 overflow-y-auto transition-all duration-300 shadow-sm"
            style={{
                left: leftPosition,
                width: width
            }}
        ...
        >
            <div className="p-4">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    {isExpanded && (
                        <h2 className="text-base font-bold text-gray-800 dark:text-gray-100 dark:text-gray-100 leading-tight whitespace-nowrap">
                                ...
                                <li>
                                    <Link 
                                        ...
                                        className={`flex items-center gap-3 px-2.5 py-2 rounded-md text-sm font-medium transition-all ${
                                            isActive('/businesses')
                                                ? 'bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-200 border-l-2 border-blue-600'
