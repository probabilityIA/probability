            ...
            <>
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <button
                  ...
                  className="w-full max-w-xs flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 text-white dark:text-white border border-red-600 dark:border-red-700 transition-colors font-medium text-sm"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
