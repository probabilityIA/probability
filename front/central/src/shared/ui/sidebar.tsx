            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  href="/home"
                  className={`
                    flex items-center gap-1 p-2 rounded-lg transition-colors duration-300
                    ${isActive('/home')
              ...
              {canViewNotifications && (
                <li>
                  ...
                  >
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/512/1384/1384162.png" alt="Notificaciones" className="w-4 h-4 flex-shrink-0 object-contain" />
                    {primaryExpanded && (
